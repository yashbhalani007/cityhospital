import { AUTH_ERROR, FORGOT_REQUEST, FORGOT_RESPONSE, LOGIN_REQUEST, LOGIN_RESPONSE, LOGOUT_REQUEST, SIGNUP_REQUEST, SIGNUP_RESPONSE } from "../ActionTypes"
...
export const forgotResponse = () => (dispatch) => {
